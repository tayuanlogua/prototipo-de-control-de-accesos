document.addEventListener("DOMContentLoaded", function () {
  ...
  // Completa el campo "Suerte" con un valor generado (puedes ajustar esto según sea necesario)
  const suerteInput = document.getElementById("suerte");
  suerteInput.value = "Suerte Generada"; // Ajustar según la lógica que necesites

  // Completa los campos de selección de número y letra con opciones
