document.addEventListener("DOMContentLoaded", () => {
  ...
  const fumigationForm = document.getElementById("fumigation-form");

  fumigationForm.addEventListener("submit", (event) => {
  ...
  // --- Formulario de Caña Quemada ---
  const burntCaneForm = document.getElementById("burnt-cane-form");
